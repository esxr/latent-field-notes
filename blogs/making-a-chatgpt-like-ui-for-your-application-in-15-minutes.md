---
title: "Making a ChatGPT-like UI for your application in 15 minutes"
date: "2024-06-24"
description: "Creating a Generic Chat UI that we can use with ANY LLM solution we create in future"
tags: ["ai", "genai", "langchain", "open-webui", "ollama"]
draft: false
---

![](https://miro.medium.com/v2/resize:fit:700/0*zJD0PYmqFxLLGZl9.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*UdvI2iCbRGreTGOw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*KFLRHgJciX8n5O7g.png)
...
[https://github.com/esxr/local\_llms\_rag\_solution](https://github.com/esxr/local_llms_rag_solution)
...
![](https://miro.medium.com/v2/resize:fit:700/0*QPPxVbWP1jPvHyGs.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*w2S-8e4lu789C0vz.jpg)
...
![](https://miro.medium.com/v2/resize:fit:700/0*0Z1NqRKfE0jfGOVu.jpg)
...
Go to the dashboard at: http://localhost:8080. You should see the dashboard without any errors.

![](https://miro.medium.com/v2/resize:fit:700/0*xNz3vby3kGeyrkx4.jpg)

Now select the model you want and chat. You should see the chat working as expected.

![](https://miro.medium.com/v2/resize:fit:700/0*zsSqrMCwyxHTMpsL.jpg)
...
![](https://miro.medium.com/v2/resize:fit:700/0*g6mHJDqH9IeMCSOQ.jpg)
...
![](https://miro.medium.com/v2/resize:fit:700/0*DH_XHEJ-2d646UlY.jpg)
...
![](https://miro.medium.com/v2/resize:fit:700/0*f_Jhc2ANLDN-QX1-.jpg)
...
![](https://miro.medium.com/v2/resize:fit:700/0*WSYHl6lgIVrYUesj.png)
