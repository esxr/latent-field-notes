---
title: "Adding ChatGPT-Like functionality to MacOS Spotlight Search"
date: "2024-06-24"
description: "Adding ChatGPT like search system to the MacOS filesystem with Spotlight, Ollama, and LangChain"
tags: ["ai", "genai", "langchain", "langsmith", "ollama"]
draft: false
---

![](https://miro.medium.com/v2/resize:fit:700/0*Pr09E-NGy4brcjxl.png)

![](https://miro.medium.com/v2/resize:fit:700/0*rja2PX_7W38z_o4a.png)
...
![](https://miro.medium.com/v2/resize:fit:650/0*ZO6NVhTIA-QQl_FA.png)
...
For this exercise let's assume all our documents are PDFs. Let's write the get\_docs function to extract text documents from pdf files.
...
![](https://miro.medium.com/v2/resize:fit:700/0*soWtsF9Br6EPbqVP.jpg)

2. Create your API key for your Organization

![](https://miro.medium.com/v2/resize:fit:700/0*65eWCaTdBxyxzk03.jpg)

3. Create a new project

![](https://miro.medium.com/v2/resize:fit:700/0*GHMM6keqTz51dEZo.jpg)

4. Setup the environment variables. I have set these up in my `.zshrc`.

![](https://miro.medium.com/v2/resize:fit:700/0*xqhpKMn5sBlga0V5.jpg)

5. Let's now run our LLM layer.

![](https://miro.medium.com/v2/resize:fit:700/0*BCHK9lAoS2ajqCd2.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*4GHzkz-NUiBJjKuK.png)

We see a trace for our chain execution. Let's expand it

![](https://miro.medium.com/v2/resize:fit:700/0*mw2VjFCIIjBikEfl.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*0ewyndBZlt7-MtR7.png)

For the prompt, we can see data input to the template, and the prompt generated from it

![](https://miro.medium.com/v2/resize:fit:700/0*hcYLooB2oizzm5Bd.png)

For the chat model, we can see the prompt input to the model, and the output generated by it

![](https://miro.medium.com/v2/resize:fit:700/0*On5_9aZspHglUU6z.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*2WCuPbjhZeOXqYII.png)

Since we don't already have a dataset, we'll create a new one

![](https://miro.medium.com/v2/resize:fit:700/0*j5x-Ngh8QyKKZeeU.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*ob9nqt5_zqJ9PdYA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*LVwF28xobQP4DSrj.png)
